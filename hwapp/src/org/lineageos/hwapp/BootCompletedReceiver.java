...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        String spkRcvStereoSupport =
                AudioSystem.getParameters("audio_capability#spk_rcv_stereo_support");
        if (spkRcvStereoSupport != null && spkRcvStereoSupport.contains("true")) {
